...
public class Univeristy_Data_Importing {
	JFrame frame;
	JPanel mainpanle;
	JButton submit;
	JButton cancel;
	...
	public Univeristy_Data_Importing() {
		frame = new JFrame();
		...
		liftLable = new JLabel("Import University Information");
		viewLable = new JLabel("View");
		import_B = new JButton("Import");
		importLable = new JLabel("Click On Import To Add University File");
		...
		mainLable = new JLabel("University Data Importing");
		...
		frame.setTitle("University Data Importing");
		...
		for (UniversityDM universityDM : UniversityService.AllUniveristyDM) {
			// System.out.println(studentDM.dataprint());
			alldata = alldata + universityDM.printdata();

			model.addElement(universityDM.printdata2());
	...
	ActionListener deleteAction = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (dataArea.getSelectedValue() != null) {
				...
				UniversityService.AllUniveristyDM = null;
				new UniversityService().loadUniversitytoLists();
				String alldata = "";
	...
	public UniversityDM findStudentRecord(String s) {
		for (UniversityDM universityDM : UniversityService.AllUniveristyDM) {
			String selecteddata[] = s.split(" - ");
			if (universityDM.getName().equals(selecteddata[0])
					&& universityDM.getAbbreviation().equals(selecteddata[1])) {
				return universityDM;
			}
		}
		return null;
	...
	public int getIndexOFstudent(UniversityDM university) {
		int x = 0;
		for (UniversityDM universityDM : UniversityService.AllUniveristyDM) {
			x++;
			if (universityDM == university) {
				return x;
			}
		}
		return -1;
	...
	public void removeanStuden(String lineToRemove) throws IOException {
		...
		File inputFile = new File("TestUniversity.txt");
