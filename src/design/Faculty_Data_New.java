...
import Service.FacultyServiceNew;
import Service.StudentService;

public class Faculty_Data_New {
	JFrame frame;
	JPanel mainpanle;
	JButton submit;
	JButton cancel;
	...
	public Faculty_Data_New() {
		...
		// dataArea.setv
		new FacultyServiceNew().loadFacultyIntoLists();
		String alldata = "";
	...
	ActionListener deleteAction = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (dataArea.getSelectedValue() != null) {
				...
				FacultyServiceNew.AllFacultyDMNew = null;
				new FacultyServiceNew().loadFacultyIntoLists();
				String alldata = "";
				// JOptionPane.showMessageDialog(null,
				// StudentService.AllStdeuntsDM.size());
	...
	public FacultyDMNew findFaculryRecord(String s) {
		for (FacultyDMNew facultyDM : FacultyServiceNew.AllFacultyDMNew) {
	...
	public int getIndexOFstudent(FacultyDMNew faculty) {
		int x = 0;
		for (FacultyDMNew facultyDM : FacultyServiceNew.AllFacultyDMNew) {
			x++;
